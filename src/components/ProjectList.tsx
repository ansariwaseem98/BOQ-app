      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Manage your tender estimation projects, contractual records, and engineering workspaces.
          </p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50 text-[11px] font-bold text-slate-600 uppercase tracking-wider">
                  ...
                  <th className="py-3 px-4">Tender Deadline</th>
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-1.5 text-slate-600 font-mono text-[11px]">
                          ...
                          <span>{proj.tender?.tenderSubmissionDeadline || proj.project?.tenderSubmissionDeadline || '-'}</span>
                        </div>
                      </td>
